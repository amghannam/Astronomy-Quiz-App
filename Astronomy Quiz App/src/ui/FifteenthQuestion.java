...
public class FifteenthQuestion extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FifteenthQuestion() {
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 450, 336);
		setLocationRelativeTo(null); 
		setTitle("Astronomy Quiz: Question 15");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 15", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html> The Universe began approximately...");
		...
		JRadioButton rdbtFirst = new JRadioButton("1 billion years ago");
		...
		JRadioButton rdbtSecond = new JRadioButton("4.5 billion years ago");
		...
		JRadioButton rdbtThird = new JRadioButton("7.9 billion years ago");
		...
		JRadioButton rdbtFourth = new JRadioButton("13.8 billion years ago");
		...
		JRadioButton rdbtFifth = new JRadioButton("20 billion years ago");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtFourth.isSelected()) {
					...
					IncorrectlyAnsweredList.update("15");
				}
				dispose();
				Timer.stop();
