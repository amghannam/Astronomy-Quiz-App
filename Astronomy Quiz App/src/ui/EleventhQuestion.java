...
public class EleventhQuestion extends JFrame {
	...
	public EleventhQuestion() {
		...
		setTitle("Astronomy Quiz: Question 11");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 11", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html> This galaxy lies approximately 2.5 million light years from Earth. "
				+ "Which of the following galaxies is it?"); 
		...
		JRadioButton rdbtFirst = new JRadioButton("The Andromeda Galaxy");
		...
		rdbtFirst.setBounds(152, 9, 256, 23);
		pnlChoices.add(rdbtFirst);
		
		JRadioButton rdbtSecond = new JRadioButton("The Whirlpool Galaxy");
		...
		rdbtSecond.setBounds(152, 35, 256, 23);
		pnlChoices.add(rdbtSecond);
		
		JRadioButton rdbtThird = new JRadioButton("The Triangulum Galaxy");
		...
		rdbtThird.setBounds(152, 61, 256, 23);
		pnlChoices.add(rdbtThird);
		
		JRadioButton rdbtFourth = new JRadioButton("The Small Magellanic Cloud");
		...
		rdbtFourth.setBounds(152, 90, 256, 23);
		pnlChoices.add(rdbtFourth); 
		
		JRadioButton rdbtFifth = new JRadioButton("The Large Magellanic Cloud");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtFirst.isSelected()) {
					...
					IncorrectlyAnsweredList.update("11");
				}
				dispose();
				new TwelfthQuestion().setVisible(true);
			}
		});
