...
public class FirstQuestion extends JFrame {
	...
	public FirstQuestion() {
		...
		setTitle("Astronomy Quiz: Question 1");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Question 1",
		...
		JLabel lblQuestionText = new JLabel("<html>A main-sequence star with 18.0 solar masses "
				+ "would probably have which of the following colors?");
		lblQuestionText.setBounds(10, 25, 394, 44);
		pnlQuestion.add(lblQuestionText);

		JPanel pnlChoices = new JPanel();
		pnlChoices.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Select an answer",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlChoices.setBounds(10, 102, 424, 148);
		contentPane.add(pnlChoices);
		pnlChoices.setLayout(null);

		JRadioButton rdbtFirst = new JRadioButton("Orange");
		...
		JRadioButton rdbtSecond = new JRadioButton("Yellow");
		rdbtSecond.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtSecond.isSelected())
					btnNextQuestion.setEnabled(true);
			}
		});
		...
		JRadioButton rdbtThird = new JRadioButton("Red");
		...
		JRadioButton rdbtFourth = new JRadioButton("Blue");
		...
		JRadioButton rdbtFifth = new JRadioButton("Green");
		rdbtFifth.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtFifth.isSelected())
					btnNextQuestion.setEnabled(true);
			}
		});
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtFourth.isSelected()) {
					...
					IncorrectlyAnsweredList.update("1");
				}
				dispose();
