...
public class FourteenthQuestion extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FourteenthQuestion() {
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 450, 336);
		setLocationRelativeTo(null); 
		setTitle("Astronomy Quiz: Question 14");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 14", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html> Which of the following is the region within which "
		...
		JRadioButton rdbtFirst = new JRadioButton("Sagittarius");
		...
		JRadioButton rdbtSecond = new JRadioButton("Horsehead Nebula");
		...
		JRadioButton rdbtThird = new JRadioButton("Orion Arm");
		...
		JRadioButton rdbtFourth = new JRadioButton("Far Rim");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtThird.isSelected()) {
					...
					IncorrectlyAnsweredList.update("14");
				}
				dispose();
				new FifteenthQuestion().setVisible(true);
			}
		});
