...
public class EighthQuestion extends JFrame {
	...
	public EighthQuestion() {
		...
		setTitle("Astronomy Quiz: Question 8");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 8", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html> Mars is well-known to house significant "
				+ "amounts of carbon dioxide. Approximately what percentage of the Martian atmosphere "
				+ "is composed of carbon dioxide?");
		...
		JRadioButton rdbtFirst = new JRadioButton("45%");
		...
		JRadioButton rdbtSecond = new JRadioButton("59%");
		...
		JRadioButton rdbtThird = new JRadioButton("71%");
		...
		JRadioButton rdbtFourth = new JRadioButton("84%");
		...
		JRadioButton rdbtFifth = new JRadioButton("96%");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtFifth.isSelected()) {
					...
					IncorrectlyAnsweredList.update("8");
				}
				dispose();
				new NinthQuestion().setVisible(true);
			}
		});
