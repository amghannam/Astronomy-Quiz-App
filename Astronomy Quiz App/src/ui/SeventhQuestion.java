...
public class SeventhQuestion extends JFrame {
	...
	public SeventhQuestion() {
		...
		setTitle("Astronomy Quiz: Question 7");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 7", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html> Which of the following is unique to the planet "
				+ "Uranus?"); 
		...
		JRadioButton rdbtFirst = new JRadioButton("It is larger than Earth.");
		...
		JRadioButton rdbtSecond = new JRadioButton("It has more than 10 known satellites.");
		...
		JRadioButton rdbtThird = new JRadioButton("It is tipped on its axis by 90+ degrees.");
		...
		JRadioButton rdbtFourth = new JRadioButton("It has a ring system.");
		...
		JRadioButton rdbtFifth = new JRadioButton("It is the furthest planet from the Sun.");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtThird.isSelected()) {
					...
					IncorrectlyAnsweredList.update("7");
				}
				dispose();
				new EighthQuestion().setVisible(true);
			}
		});
