...
public class FourthQuestion extends JFrame {
	...
	public FourthQuestion() {
		...
		setTitle("Astronomy Quiz: Question 4");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 4", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html>The star Deneb is informally classified as a... "); 
		...
		JRadioButton rdbtFirst = new JRadioButton("Red supergiant");
		...
		JRadioButton rdbtSecond = new JRadioButton("Blue-white supergiant");
		...
		rdbtSecond.setBounds(152, 35, 170, 23);
		pnlChoices.add(rdbtSecond);
		
		JRadioButton rdbtThird = new JRadioButton("Yellow giant");
		...
		JRadioButton rdbtFourth = new JRadioButton("White dwarf");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtSecond.isSelected()) {
					...
					IncorrectlyAnsweredList.update("4");
				}
				dispose();
