...
public class ThirdQuestion extends JFrame {
	...
	public ThirdQuestion() {
		...
		setTitle("Astronomy Quiz: Question 3");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 3", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html>Including the Sun, the third-brightest star in "
				+ "the night sky is...");
		...
		JRadioButton rdbtFirst = new JRadioButton("Sirius");
		...
		JRadioButton rdbtSecond = new JRadioButton("Arcturus");
		...
		JRadioButton rdbtThird = new JRadioButton("Betelgeuse");
		...
		JRadioButton rdbtFourth = new JRadioButton("Rigel");
		...
		JRadioButton rdbtFifth = new JRadioButton("Tau Ceti");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtSecond.isSelected()) {
					...
					IncorrectlyAnsweredList.update("3");
				}
				dispose();
				new FourthQuestion().setVisible(true);
			}
		});
		btnNextQuestion.setBounds(303, 260, 131, 23);
