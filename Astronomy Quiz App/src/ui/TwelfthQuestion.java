...
public class TwelfthQuestion extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TwelfthQuestion() {
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 450, 336);
		setLocationRelativeTo(null); 
		setTitle("Astronomy Quiz: Question 12");
		...
		pnlQuestion.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), 
				"Question 12", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 128)));
		pnlQuestion.setBounds(10, 11, 424, 80);
		contentPane.add(pnlQuestion);
		pnlQuestion.setLayout(null);
		
		JLabel lblQuestionText = new JLabel("<html> How many known constellations are there in the night sky?"); 
		...
		JRadioButton rdbtFirst = new JRadioButton("12");
		...
		JRadioButton rdbtSecond = new JRadioButton("40");
		...
		JRadioButton rdbtThird = new JRadioButton("64");
		...
		JRadioButton rdbtFourth = new JRadioButton("88");
		...
		JRadioButton rdbtFifth = new JRadioButton("107");
		...
		btnNextQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (rdbtFourth.isSelected()) {
					...
					IncorrectlyAnsweredList.update("12");
				}
				dispose();
				new ThirteenthQuestion().setVisible(true);
			}
		});
